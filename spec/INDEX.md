...
Critical path = 8 weekends at ~6h each (~54h implementation-only). Plan for **75–110h ship-ready** with debugging, docs, packaging, clean-machine `uvx` testing, and broken-slug edge cases. M04, M05, M10 parallelize.
